...
installpaths_api_version_major = 1
installpaths_api_version_minor = 1
installpaths_api_version_patch = 0

# Incrementare di 1 il valore di questa variabile ogni volta che si modifica
# il valore delle variabili sottostanti
installpaths_revision = 0
